...
- (BOOL)stringIsPalindrome:(NSString *)string {
    ...
    NSString *withoutPuntuation = [string copy];
    
    for (NSUInteger i = 0; i < [punctuations count]; i++) {
        NSString *punctuation = punctuations[i];
        withoutPuntuation = [withoutPuntuation stringByReplacingOccurrencesOfString:punctuation withString:@""];
    }
        
    
    
    NSString *spaceless = [withoutPuntuation stringByReplacingOccurrencesOfString:@" " withString:@""];
