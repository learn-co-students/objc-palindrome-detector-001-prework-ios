...
/*
 ...
 Create a new BOOL variable called palindromeIsPalindrome and use it to capture the return of calling stringIsPalindrome: on self with palindrome submitted as the method argument:
 BOOL palindromeIsPalindrome = [self stringIsPalindrome:palindrome];
 Now, NSLog() these variables together to view the result:
