...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *kannakanak = @"Kanakanak";
    BOOL kannakanakIsPalindrome = [self stringIsPalindrome:kannakanak];
    NSLog(@"%d : %@", kannakanakIsPalindrome, kannakanak);
    ...
    BOOL palindromeIsPlaindrome = [self stringIsPalindrome:palindrome];
    NSLog(@"%d : %@", palindromeIsPlaindrome, palindrome);
