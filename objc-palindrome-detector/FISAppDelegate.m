...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *aibonhphobia = @"aibonhphobia";
    BOOL aibonhphobiaIsPalindrome = [self stringIsPalindrome:aibonhphobia];
    NSLog(@"%d : %@", aibonhphobiaIsPalindrome, aibonhphobia);
    
    NSString *notAPalindrome = @"this is not a palindrome";
    BOOL notAPalindromeIsPalindrome = [self stringIsPalindrome:notAPalindrome];
    NSLog(@"%d : %@", notAPalindromeIsPalindrome, palindrome);
