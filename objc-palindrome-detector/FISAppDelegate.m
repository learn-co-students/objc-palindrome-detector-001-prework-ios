...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
   ...
   NSString *reversed = [self stringByReversingString:palindrome];
    ...
    //Single-word Palindromes, Check for Uppercase
    ...
    // Phrases that are palindromes, Check for Spaces
    ...
    // Full Sentences with Punctualization and Capitalization. Last one! Let's do it!!
