...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self debugStringIsPalindrome:@"Norma is as selfless as I am, Ron."];
    
    [self debugStringIsPalindrome:@"No sir! Away! A papaya war is on."];
...
- (void)debugStringIsPalindrome:(NSString *)string {
    BOOL isPalindrome = [self stringIsPalindrome:string];
    NSLog(@"%d : %@", isPalindrome, string);
}
