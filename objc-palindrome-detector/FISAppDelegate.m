...
- (BOOL) stringIsPalindrome:(NSString *)string {
    ...
    NSString *withoutPunctiations=[string copy];
    
    for (NSUInteger i =0;i<[punctuations count];i++) {
        NSString *punctuation=punctuations[i];
        withoutPunctiations = [withoutPunctiations stringByReplacingOccurrencesOfString:punctuation withString:@""];
    }
    
    NSString *spaceless = [withoutPunctiations stringByReplacingOccurrencesOfString:@" " withString:@""];
